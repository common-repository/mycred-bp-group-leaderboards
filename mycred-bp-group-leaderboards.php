...
if ( ! class_exists( 'myCRED_BP_Group_Leaderboards' ) ) :
	final class myCRED_BP_Group_Leaderboards {
		 ...
		 * @version 1.0
		 */
		public function __clone() { _doing_it_wrong( __FUNCTION__, 'Cheatin&#8217; huh?', '1.2.8' ); }
		 ...
		 * @version 1.0
		 */
		public function __wakeup() { _doing_it_wrong( __FUNCTION__, 'Cheatin&#8217; huh?', '1.2.8' ); }
...
<div class="wrap">
	...
	<?php else: ?>
	<h1><?php _e( 'myCred BP Group Leaderboard Settings', 'bpmycredleaderboard' ); ?> <a href="https://mycred.me/store/mycred-bp-group-leaderboards/" class="page-title-action" target="_blank"><?php _e( 'Documentation', 'bpmycredleaderboard' ); ?></a></h1>
	<?php endif; ?>
